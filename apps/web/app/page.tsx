...
import { loadShowcaseProducts } from '@/lib/catalog-data';
...
export default async function HomePage() {
  ...
  return <>
    ...
    <section className="section-tight"><Container><div className="section-heading"><p className="eyebrow">FIRST DROP</p><h2>추석 육포 선물세트</h2><p className="muted">용도와 예산에 맞춰 300g부터 600g까지 준비했습니다.</p></div><div className="grid-4">{showcase.products.map((product) => <ProductCard key={product.id} product={product} interactive={false} showPrice={showcase.priceVisible} />)}</div></Container></section>
