...
> 마지막 갱신: **2026-09-01 (Asia/Seoul)** — 목록/장바구니 썸네일 분리 및 600g·480g 대표 이미지 등록 포함
...
- `/account`: 주문 내역·장바구니·배송지 관리의 회원 허브. 본인 추천코드별 직접 유입 회원 수, 유입 회원의 표시명·가입일·유입 방식과 기록된 UTM, 수수료 요약을 보여줍니다. 추천 유입 회원 조회는 현재 로그인한 referrer에 귀속된 관계만 읽도록 제한합니다.
