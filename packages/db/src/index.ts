...
export type Database = {
  public: {
    Tables: {
      ...
      >;
      products: Table<
        { id: string; slug: string; name: string; category: string; short_description: string; description: string; base_price: number; supply_cost: number | null; shipping_fee: number; shipping_bundle_quantity: number; home_sort_order: number; visibility: 'public' | 'member' | 'referral' | 'hidden'; status: 'draft' | 'active' | 'paused' | 'archived'; created_at: string },
        { slug: string; name: string; category?: string; short_description?: string; description?: string; base_price: number; supply_cost?: number | null; shipping_fee?: number; shipping_bundle_quantity?: number; home_sort_order?: number; visibility?: 'public' | 'member' | 'referral' | 'hidden'; status?: 'draft' | 'active' | 'paused' | 'archived' },
        { slug?: string; name?: string; category?: string; short_description?: string; description?: string; base_price?: number; supply_cost?: number | null; shipping_fee?: number; shipping_bundle_quantity?: number; home_sort_order?: number; visibility?: 'public' | 'member' | 'referral' | 'hidden'; status?: 'draft' | 'active' | 'paused' | 'archived' }
      >;
